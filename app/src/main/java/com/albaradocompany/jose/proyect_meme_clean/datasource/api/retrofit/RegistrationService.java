...
import com.albaradocompany.jose.proyect_meme_clean.datasource.api.RegistrationApiResponse;
...
public interface RegistrationService {
    @FormUrlEncoded
    @POST("insertUser.php")
    Call<RegistrationApiResponse> getRegistrationResult(@Field("idUser") String idUser,
